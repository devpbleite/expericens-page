  ...
  return (
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas, voluptates?</p>
        <p className="pb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt, quo. Omnis quaerat non ducimus doloribus, rem aperiam aliquid velit possimus commodi architecto aspernatur. Qui esse excepturi corrupti autem, adipisci nostrum.</p>
        <div>
